...
def chart_specs() -> tuple[ChartSpec, ...]:
    return (
        ...
        ChartSpec("images-benchmark-large-streaming-chart-01", "Large Streaming Pipeline", "Complete large-file pipeline latency.", "ms/op", "lower is better", (("Scrimage Path", (223.19, 145.13)), ("Scrimage Okio", (222.00, 145.59)), ("Scrimage suspended", (254.95, 170.69)), ("vips Path", (7.13, 5.47)), ("vips stream", (23.99, 15.59))), ("JPEG", "PNG"), "large-streaming-2026-06-05.md", True),
