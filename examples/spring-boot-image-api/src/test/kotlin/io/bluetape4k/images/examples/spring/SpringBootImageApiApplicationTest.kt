...
class SpringBootImageApiApplicationTest(
    ...
    @Test
    fun `rejects upload when image dimensions cannot be probed before thumbnail generation`() {
    ...
    @Test
    fun `rejects header-valid malformed image before thumbnail generation`() {
        val malformedImage = MockMultipartFile(
            "file",
            "malformed.png",
            MediaType.IMAGE_PNG_VALUE,
